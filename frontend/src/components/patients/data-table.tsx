...
interface DataTableProps<TData extends ClientWithDisplayFields, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function DataTable<TData extends ClientWithDisplayFields, TValue>({
  columns,
  data,
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <div className="flex items-center space-x-3">
          <Button
            variant="outline"
            className="bg-white border-zinc-200 text-zinc-700 shadow-sm transition-all hover:bg-zinc-100"
          >
            Match Clinician
          </Button>
          ...
          <Button
            ...
            className={`transition-all shadow-sm ${
              isDeleteMode
                ...
                : "bg-white text-red-600 border-red-200 hover:bg-red-50 hover:text-red-700 hover:border-red-300"
            }`}
          >
          ...
          >
            <Plus className="w-4 h-4 mr-1.5" /> New Patient Intake
          </Button>
        </div>
      </div>

      {isDeleteMode && selectedCount > 0 && (
        <div className="flex items-center gap-3 bg-red-50/50 p-2 rounded-md border border-red-100 transition-all mx-1">
          ...
          <Button
            ...
            disabled={isDeleting}
            variant="outline"
            className="h-8 bg-white text-red-600 border-red-200 hover:bg-red-100 hover:border-red-300"
          >
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-sm shadow-xl border border-zinc-200">
            ...
            <div className="flex justify-end gap-3 pt-2">
              <Button
                ...
                disabled={isDeleting}
                className="transition-all duration-200 hover:bg-zinc-200 hover:text-zinc-900 hover:border-zinc-400"
              >
                Cancel
              </Button>
              <Button
                ...
                disabled={isDeleting}
                className="bg-red-600 text-white transition-all duration-200 hover:bg-red-50 hover:text-red-700 hover:border-red-500"
              >
