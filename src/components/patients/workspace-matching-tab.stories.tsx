/**
 * @file        workspace-matching-tab.stories.tsx
 * @description Storybook stories for the WorkspaceMatchingTab component, demonstrating Default, Loading, Error, and Empty states.
...
const meta = {
  title: "Features/Workspace/WorkspaceMatchingTab",
  component: WorkspaceMatchingTab,
  tags: ["autodocs"],
}
...
/**
 * Default interactive matching panel story
 */
...
export const Loading = {
  ...
  render: (args: React.ComponentProps<typeof WorkspaceMatchingTab>) => (
    <div className="opacity-50 pointer-events-none">
      <WorkspaceMatchingTab {...args} />
    </div>
  ),
}
...
export const Error = {
  ...
  render: () => (
    <div className="p-8 border border-[var(--color-danger-500)] bg-[var(--color-danger-50)] text-[var(--color-danger-600)] text-sm rounded-xl text-center">
      Failed to connect to clinicians match engine database.
    </div>
  ),
}
